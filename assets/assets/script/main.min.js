    ...
    var e = {
            ...
            n(457),
                ...
                (function () {
                    var e = new h.PlotterCanvas2D(),
                        ...
                        r = !0;
                    function a() {
                        r && (n.reset(s.Parameters.linesOpacity, s.Parameters.linesThickness), t.reset(), (r = !1)),
                            n.computeNextSegments(20) && s.Parameters.showIndicators && n.updateIndicators(Page.Canvas.setIndicatorText),
                            t.plot(),
                            s.Parameters.debug && n.drawDebugView(e.context),
                    ...
                    function u(a) {
                        Page.Canvas.showLoader(!1), (n = new d.ThreadComputer(a)), (t = new l.ThreadPlotter(e, n)), (r = !0);
                    }
                    s.Parameters.addRedrawObserver(function () {
                        ...
                        s.Parameters.addBlurChangeObserver(o),
                        o(s.Parameters.blur),
                        s.Parameters.addFileUploadObserver(u),
                        Page.Canvas.showLoader(!0);
                    var p = new Image();
                    p.addEventListener("load", function () {
                        u(p), requestAnimationFrame(a);
                    }),
                        (p.src = img ),
                        s.Parameters.addDownloadObserver(function () {
                            var e = new c.PlotterSVG();
                            new l.ThreadPlotter(e, n).plot();
                            var t = e.export();
                            i.downloadTextFile(t, "image-as-threading.svg");
                        }),
                        s.Parameters.addDownloadInstructionsObserver(function () {
                            var e = n.instructions;
                            steps = e;
                            // i.downloadTextFile(e, "image-as-threading_instructions.txt");
                        });
                })();
        },
        457: function () { },
        61: function (e, t, n) {
            ...
            Page.Tabs.addObserver(c, O),
                Page.Range.addLazyObserver(d, O),
                Page.Tabs.addObserver(l, O),
            ...
            var x = "1" === i.getQueryStringValue("debug");
            function T() {
            ...
            var S = (function () {
                ...
                return (
                    ...
                    Object.defineProperty(e, "quality", {
                        get: function () {
                            return +Page.Tabs.getValues(l)[0];
                        },
                        enumerable: !1,
                        configurable: !0,
                    }),
            ...
            (t.Parameters = S), Page.Tabs.addObserver(u, E), Page.Checkbox.addObserver(v, E), E();
        },
        781: function (e, t, n) {
            var r, a;
            Object.defineProperty(t, "__esModule", { value: !0 }),
            ...
            (t.useAdvancedCompositing = function () {
                ...
                (t.computeRawColor = i),
                (t.applyCanvasCompositing = function (e, t, n, a) {
                    var h = i(t);
                    if (o) {
                        var c = a === r.LIGHTEN ? "lighter" : "difference";
                        ...
                        (o = !1), Page.Demopage.setErrorMessage("advanced-compositing-not-supported", "Your browser does not support canvas2D compositing '".concat(c, "'. The project will not run as expected."));
                    }
                    s(e),
        ...
        792: function (e, t) {
            ...
            var n = (function () {
                function e() { }
                return (
                    (e.prototype.drawBrokenLine = function (e, t, n, r, a) {
                        for (var o = [], i = 0; i < e.length - 1; i++) o.push({ from: e[i], to: e[i + 1] });
                        this.drawLines(o, t, n, r, a);
                    }),
                    e
                );
            })();
        ...
        886: function (e, t, n) {
            ...
            var s = (function (e) {
                function t() {
                    var t,
                        n = e.call(this) || this;
                    return (n.canvas = Page.Canvas.getCanvas()), (n.context = n.canvas.getContext("2d", { alpha: !1 })), (n.cssPixel = null !== (t = window.devicePixelRatio) && void 0 !== t ? t : 1), n;
                }
                return (
                    a(t, e),
                    ...
                    (t.prototype.initialize = function (e) {
                        (this.context.fillStyle = e.backgroundColor), (this.context.lineJoin = "round"), (0, o.resetCanvasCompositing)(this.context), this.context.fillRect(0, 0, this.canvas.width, this.canvas.height);
                    }),
                    ...
                    (t.prototype.drawLines = function (e, t, n, r, a) {
                        if (e.length >= 1) {
                            (0, o.applyCanvasCompositing)(this.context, t, n, r), (this.context.lineWidth = a * this.cssPixel);
                            ...
                            (0, o.resetCanvasCompositing)(this.context);
                        }
                    }),
                    (t.prototype.drawPoints = function (e, t, n) {
                        if (e.length > 0) {
                ...
                c = (function (e) {
                    ...
                    return (
                        ...
                        (t.prototype.initialize = function (e) {
                            (this.writer = new s.XMLWriter()),
                                ...
                                (this.writer.startBlock("<defs>"),
                                    this.writer.startBlock('<filter id="'.concat(h, '" x="0" y="0">')),
                                    ...
                                    this.writer.startBlock('<g filter="url(#'.concat(h, ')">'))),
                        ...
                        (t.prototype.drawLines = function (e, t, n, r, a) {
                            if (e.length >= 1) {
                                var i = void 0;
                                if ((0, o.useAdvancedCompositing)()) {
                                    this.writer.startBlock("<defs>"),
                                        this.writer.startBlock('<style type="text/css">'),
                                        this.writer.startBlock("<![CDATA["),
                                        this.writer.addLine("line { mix-blend-mode: difference; }"),
                                        r === o.ECompositingOperation.LIGHTEN && this.writer.addLine("svg { filter: invert(1); background: black; }"),
                                        this.writer.endBlock("]]>"),
                                        this.writer.endBlock("</style>"),
                                        this.writer.endBlock("</defs>");
                                    var s = Math.ceil(255 * n),
                                        h = (0, o.computeRawColor)(t);
                                    i = "rgb("
                                        .concat(h.r * s, ", ")
                                        .concat(h.g * s, ", ")
                                        .concat(h.b * s, ")");
                                } else
                                    (s = (0, o.useAdvancedCompositing)() ? 255 : 0),
                                        (h = (0, o.computeRawColor)(t)),
                                        (i = "rgba("
                                            .concat(h.r * s, ", ")
                                            .concat(h.g * s, ", ")
                        ...
                        (t.prototype.export = function () {
                            ...
                            return console.log("Concatenation took ".concat(Date.now() - e, " ms.")), t;
                        }),
                        Object.defineProperty(t.prototype, "size", {
                            get: function () {
                ...
                return (
                    (e.prototype.drawThread = function (e, t) {
                        var n = this,
                            ...
                            i = a.scaling * this.hiddenCanvasScale * this.lineThickness,
                            s = r.Parameters.invertColors ? o.ECompositingOperation.LIGHTEN : o.ECompositingOperation.DARKEN;
                        this.thread.iterateOnThreads(t, function (t, r) {
                            for (var o = [], h = 0, c = t; h < c.length; h++) {
                                var d = c[h];
                                o.push(a.transform(d));
                            }
                            e.drawBrokenLine(o, r, n.lineOpacity, s, i);
                        });
                    }),
                    (e.prototype.drawPegs = function (e) {
                        for (var t = this.computeTransformation(e.size), n = t.scaling * this.hiddenCanvasScale * 0.5, r = [], a = 0, o = this.pegs; a < o.length; a++) {
                            var i = o[a];
                            r.push(t.transform(i));
                        }
                        e.drawPoints(r, "red", n);
                    }),
                    ...
                    (e.prototype.computeNextSegments = function (e) {
                        var t = this,
                            n = performance.now(),
                            a = r.Parameters.nbLines;
                        if (this.nbSegments === a) return !1;
                        if (this.nbSegments > a)
                            return (
                                this.thread.lowerNbSegments(a),
                                this.resetHiddenCanvas(),
                                this.thread.iterateOnThreads(0, function (e, n) {
                                    (0, o.applyCanvasCompositing)(t.hiddenCanvasContext, n, t.lineOpacityInternal, o.ECompositingOperation.LIGHTEN);
                                    for (var r = 0; r + 1 < e.length; r++) t.drawSegmentOnHiddenCanvas(e[r], e[r + 1]);
                                }),
                                this.computeError(),
                                !0
                            );
                        for (var i = null; this.nbSegments < a && performance.now() - n < e;) {
                            var s = this.thread.getThreadToGrow();
                            i !== s.color && ((0, o.applyCanvasCompositing)(this.hiddenCanvasContext, s.color, this.lineOpacityInternal, o.ECompositingOperation.LIGHTEN), this.thread.enableSamplingFor(s.color), (i = s.color)),
                    ...
                    (e.prototype.reset = function (e, t) {
                        (this.lineOpacity = e),
                            ...
                            (this.hiddenCanvasScale = r.Parameters.quality),
                            r.Parameters.mode === r.EMode.MONOCHROME ? (this.thread = new i.ThreadMonochrome()) : (this.thread = new s.ThreadRedBlueGreen()),
                            this.resetHiddenCanvas(),
                    ...
                    Object.defineProperty(e.prototype, "instructions", {
                        get: function () {
                            if (r.Parameters.mode !== r.EMode.MONOCHROME) return "Instructions are only available for monochrome mode.";
                            if (r.Parameters.invertColors) return "Instructions are only available for black thread.";
                            for (var e = -1, t = -1, n = 0, a = this.pegs; n < a.length; n++) {
                                var o = a[n];
                                e < o.x && (e = o.x), t < o.y && (t = o.y);
                            }
                            var i = [];
                            i.push("Generated by https://piellardj.github.io/image-stylization-threading.\n"),
                                ...
                                i.push("Space units used below are abstract, just scale it to whatever size you want. Typically, you can choose 1 unit = 1 millimeter."),
                                i.push("Computed for a total size of ".concat(e, "x").concat(t, "."));
                            var s = this.lineThickness * this.hiddenCanvasScale;
                            i.push(
                                "Computed for a black thread of width "
                                    .concat(s, " and opacity ")
                                    .concat(this.lineOpacity, " (this is equivalent to an opaque thread of width ")
                                    .concat(s * this.lineOpacity, ").")
                            ),
                                i.push("\nFirst here are the positions of the pegs:");
                            for (var h = this.pegs, c = 0; c < h.length; c++) (h[c].name = "PEG_".concat(c)), i.push("  - ".concat(h[c].name, ": x=").concat(h[c].x.toFixed(2), " ; y=").concat(h[c].y.toFixed(2)));
                            return (
                                i.push("\nThen here are the steps of the thread:"),
                                this.thread.iterateOnThreads(0, function (e) {
                                    var t = e;
                                    i.push("  - First start from ".concat(t[0].name));
                                    for (var n = 1; n < t.length; n++)
                                        i.push(
                                            "  - then go to "
                                                .concat(t[n].name, " (this is segment ")
                                                .concat(n, " / ")
                                                .concat(t.length - 1, ")")
                                        );
                                }),
                    ...
                    (e.prototype.computeSegment = function (e) {
                        var t, n;
                        if (0 === e.length) {
                            var r = this.computeBestStartingSegment();
                            e.push(r.peg1), (t = r.peg1), (n = r.peg2);
                        } else {
                            t = e[e.length - 1];
                            var a = Math.min(e.length, 20),
                                o = e.slice(-a);
                            n = this.computeBestNextPeg(t, o);
                        }
                        e.push(n), this.drawSegmentOnHiddenCanvas(t, n);
                    }),
                    (e.prototype.resetHiddenCanvas = function () {
                        var t = e.computeBestSize(this.sourceImage, 100 * this.hiddenCanvasScale);
                        (this.hiddenCanvas.width = t.width), (this.hiddenCanvas.height = t.height), (0, o.resetCanvasCompositing)(this.hiddenCanvasContext), this.hiddenCanvasContext.drawImage(this.sourceImage, 0, 0, t.width, t.height);
                        var n = this.hiddenCanvasContext.getImageData(0, 0, t.width, t.height);
                        this.thread.adjustCanvasData(n.data, r.Parameters.invertColors), this.hiddenCanvasContext.putImageData(n, 0, 0), this.computeError(), this.initializeHiddenCanvasLineProperties();
                    }),
                    (e.prototype.computeError = function () {
                        this.uploadCanvasDataToCPU(), (this.error = { average: 0, variance: 0, meanSquare: 0 });
                        for (var e = this.hiddenCanvasData.width * this.hiddenCanvasData.height, t = 3 * e, n = 0; n < e; n++) {
                            var r = 127 - this.hiddenCanvasData.data[4 * n + 0],
                                a = 127 - this.hiddenCanvasData.data[4 * n + 1],
                                o = 127 - this.hiddenCanvasData.data[4 * n + 2];
                            (this.error.average += r + a + o), (this.error.meanSquare += r * r + a * a + o * o);
                        }
                        for (this.error.average = Math.round(this.error.average / t), this.error.meanSquare = Math.round(this.error.meanSquare / t), n = 0; n < e; n++) {
                            var i = ((r = 127 - this.hiddenCanvasData.data[4 * n + 0]) + (a = 127 - this.hiddenCanvasData.data[4 * n + 1]) + (o = 127 - this.hiddenCanvasData.data[4 * n + 2])) / 3 - this.error.average;
                            this.error.variance += i * i;
                        }
                    ...
                    (e.prototype.computeBestStartingSegment = function () {
                        for (var e = [], t = h, n = 1 + Math.floor(this.pegs.length / 100), r = 0; r < this.pegs.length; r += n)
                            for (var a = r + 1; a < this.pegs.length; a += n) {
                                var o = this.pegs[r],
                                    i = this.pegs[a];
                                if (!this.arePegsTooClose(o, i)) {
                                    var s = this.computeSegmentPotential(o, i);
                                    s > t ? ((t = s), (e = [{ peg1: o, peg2: i }])) : s === t && e.push({ peg1: o, peg2: i });
                                }
                            }
                        return u(e);
                    }),
                    (e.prototype.computeBestNextPeg = function (e, t) {
                        for (var n = [], r = h, a = 0, o = this.pegs; a < o.length; a++) {
                            var i = o[a];
                            if (!this.arePegsTooClose(e, i) && !t.includes(i)) {
                                var s = this.computeSegmentPotential(e, i);
                                s > r ? ((r = s), (n = [i])) : s === r && n.push(i);
                            }
                        }
                        return u(n);
                    }),
                    ...
                    (e.prototype.sampleCanvasData = function (e) {
                        var t = this.hiddenCanvasData.width,
                            ...
                            r = d(Math.floor(e.x), 0, t - 1),
                            a = d(Math.ceil(e.x), 0, t - 1),
                            o = d(Math.floor(e.y), 0, n - 1),
                            i = d(Math.ceil(e.y), 0, n - 1),
                    ...
                    (e.prototype.computePegs = function () {
                        ...
                        var n = r.Parameters.shape,
                            a = r.Parameters.pegsCount,
                            o = [];
                        if (n === r.EShape.RECTANGLE) {
                        ...
                        (e.prototype.plot = function () {
                            if (this.nbSegmentsDrawn !== this.threadComputer.nbSegments) {
                                if ((this.nbSegmentsDrawn > this.threadComputer.nbSegments && (this.nbSegmentsDrawn = 0), 0 === this.nbSegmentsDrawn)) {
                                    var e = { backgroundColor: r.Parameters.invertColors ? "black" : "white", blur: r.Parameters.blur };
                                    this.plotter.resize(), this.plotter.initialize(e), r.Parameters.displayPegs && this.threadComputer.drawPegs(this.plotter), this.threadComputer.drawThread(this.plotter, 0), this.plotter.finalize();
        ...
        45: function (e, t) {
            ...
            var n = (function () {
                ...
                return (
                    ...
                    (e.iterateOnThread = function (t, n, r, a) {
                        r < e.computeNbSegments(t) && a(t.slice(r), n);
                    }),
                    e
                );
            })();
                ...
                s = (function (e) {
                    ...
                    return (
                        ...
                        Object.defineProperty(t.prototype, "totalNbSegments", {
                            get: function () {
                                return i.ThreadBase.computeNbSegments(this.threadPegs);
                            },
                            enumerable: !1,
                            configurable: !0,
                        }),
                        (t.prototype.lowerNbSegments = function (e) {
                            i.ThreadBase.lowerNbSegmentsForThread(this.threadPegs, e);
                        }),
                        (t.prototype.iterateOnThreads = function (e, t) {
                            i.ThreadBase.iterateOnThread(this.threadPegs, o.EColor.MONOCHROME, e, t);
                        }),
                        (t.prototype.getThreadToGrow = function () {
                            return { thread: this.threadPegs, color: o.EColor.MONOCHROME };
                        }),
                        (t.prototype.adjustCanvasData = function (e, t) {
                            ...
                            for (var r = e.length / 4, a = 0; a < r; a++) {
                                var o = n((e[4 * a + 0] + e[4 * a + 1] + e[4 * a + 2]) / 3);
                                (e[4 * a + 0] = o), (e[4 * a + 1] = o), (e[4 * a + 2] = o);
                            }
                        }),
            ...
            var o = n(781),
                ...
                s = (function (e) {
                    ...
                    return (
                        ...
                        Object.defineProperty(t.prototype, "totalNbSegments", {
                            get: function () {
                                return i.ThreadBase.computeNbSegments(this.threadPegsRed) + i.ThreadBase.computeNbSegments(this.threadPegsGreen) + i.ThreadBase.computeNbSegments(this.threadPegsBlue);
                            },
                            enumerable: !1,
                            configurable: !0,
                        }),
                        (t.prototype.lowerNbSegments = function (e) {
                            ...
                            i.ThreadBase.lowerNbSegmentsForThread(this.threadPegsRed, t.red), i.ThreadBase.lowerNbSegmentsForThread(this.threadPegsGreen, t.green), i.ThreadBase.lowerNbSegmentsForThread(this.threadPegsBlue, t.blue);
                        }),
                        (t.prototype.iterateOnThreads = function (e, t) {
                            var n = this.computeIdealSegmentsRepartition(e);
                            i.ThreadBase.iterateOnThread(this.threadPegsRed, o.EColor.RED, n.red, t),
                                i.ThreadBase.iterateOnThread(this.threadPegsGreen, o.EColor.GREEN, n.green, t),
                                i.ThreadBase.iterateOnThread(this.threadPegsBlue, o.EColor.BLUE, n.blue, t);
                        }),
                        (t.prototype.getThreadToGrow = function () {
                            var e = this.computeIdealSegmentsRepartition(this.totalNbSegments + 1);
                            return e.red > 0 && this.threadPegsRed.length < e.red + 1
                                ? { thread: this.threadPegsRed, color: o.EColor.RED }
                                : e.green > 0 && this.threadPegsGreen.length < e.green + 1
                                    ? { thread: this.threadPegsGreen, color: o.EColor.GREEN }
                                    : { thread: this.threadPegsBlue, color: o.EColor.BLUE };
                        }),
                        (t.prototype.adjustCanvasData = function (e, t) {
                            var n,
                                r = 0,
                        ...
                        (t.prototype.enableSamplingFor = function (e) {
                            var t;
                            (t = e === o.EColor.RED ? 0 : e === o.EColor.GREEN ? 1 : 2),
                                (this.sampleCanvas = function (e, n) {
                                    return e[n + t];
                                });
                        }),
                        (t.prototype.computeIdealSegmentsRepartition = function (e) {
                            for (var t = e * this.frequencyRed, n = e * this.frequencyGreen, r = e * this.frequencyBlue, a = { red: Math.floor(t), green: Math.floor(n), blue: Math.floor(r) }; a.red + a.green + a.blue < e;) {
                                var o = t - a.red / Math.max(1, a.red + a.green + a.blue),
                                    i = n - a.green / Math.max(1, a.red + a.green + a.blue),
                                    s = r - a.blue / Math.max(1, a.red + a.green + a.blue);
                                o > i && o > s ? a.red++ : i > o && i > s ? a.green++ : a.blue++;
                            }
                            return a;
                        }),
                        t
            ...
            var n = (function () {
                function e(e, t) {
                    var n = e.width / t.width,
                        r = e.height / t.height;
                    (this.scaling = Math.min(n, r)), (this.origin = { x: 0.5 * (e.width - this.scaling * t.width), y: 0.5 * (e.height - this.scaling * t.height) });
                }
                return (
